                ...
                {featuredItems.map((item) => (
                  ...
                  >
                    <div className="relative h-24 w-full rounded-2xl overflow-hidden shadow-lg">
                      ...
                      <div className="absolute top-2 right-2 bg-white/90 backdrop-blur-md px-2 py-1 rounded-lg text-[9px] font-black text-gray-900 border border-white/20">{item.price}</div>
                    </div>
                    <div className="px-1">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0 flex flex-col justify-center space-y-2">
                        ...
                        <div className="flex items-center justify-between mt-1">
                          <span className="text-sm font-black text-gray-900 tracking-tighter">{item.price}</span>
                          {item.isPopular && (
                    ...
                    <div className="space-y-8">
                      <div className="flex items-end justify-between px-2">
                        <div className="flex flex-col">
                          ...
                          <span className="text-4xl font-black text-gray-900 tracking-tight leading-none">{selectedItem.price}</span>
                        </div>
