        ...
        <div className="lg:col-span-1 space-y-8">
           <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-gray-100 flex flex-col items-center text-center relative overflow-hidden group">
              ...
              <div className="relative mt-12 mb-6">
                 ...
                 <div className="absolute -bottom-2 -right-2 h-10 w-10 bg-brand-orange rounded-full flex items-center justify-center text-white shadow-lg border-4 border-white z-20 cursor-pointer hover:scale-110 transition-transform">
              ...
              <div className="w-full mt-10 pt-10 border-t border-gray-50 flex flex-col gap-4">
                 ...
                 <div className="flex items-center justify-between text-xs font-black uppercase tracking-widest text-gray-300">
                    ...
                    <div className={cn("h-4 w-4 rounded-full shadow-sm", THEME_COLORS.find(c => c.color === formData.themeColor)?.class || "bg-brand-orange")}></div>
                 </div>
              </div>
           </div>
           ...
           <div className="bg-primary/5 rounded-[2.5rem] p-8 border border-primary/5">
              ...
              <p className="text-sm text-primary/60 leading-relaxed font-medium">
                 A high-quality transparent logo works best for your digital menu. Try using a 512x512px PNG for the sharpest results.
              </p>
           </div>
        </div>
           ...
           <div className="bg-white rounded-[2.5rem] p-10 shadow-sm border border-gray-100">
              ...
              <div className="space-y-8">
                 ...
                 <div className="pt-8 border-t border-gray-50">
                    <label className="block text-[10px] font-black text-gray-300 uppercase tracking-widest mb-4 ml-1">Logo Appearance</label>
                    <div className="relative">
